from ui.lib.core.ext.pyse import Pyse
from ui.lib.core.ext.mymysql import MyMysql
...
class LoginPage(BasePage):
    ...
    def login_check(self, name):
        return self.d.wait_and_save_exception('css=>a[href="/user-logout.html"]', name)


class CreateBug(LoginPage):
    def tag_bug(self):
